...
class Booking(AuditMixin):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["service_date", "time_slot"], name="bookings_service_f1f4bf_idx"),
    ...
    @property
    def starts_at(self):
        return datetime.combine(self.service_date, datetime.strptime(self.time_slot, "%H:%M").time())
