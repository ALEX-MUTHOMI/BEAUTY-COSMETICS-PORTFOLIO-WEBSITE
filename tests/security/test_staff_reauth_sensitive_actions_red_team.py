...
def test_contact_reveal_requires_permission_and_recent_reauth_under_attack():
    ...
    assert client.post(staff_contact_url(booking), {"reason": "PII scrape"}, secure=True).status_code == 403
    assert (
        client.post(
